...
//////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    file2.open("datos_por_delete.txt");
    ...
    for(ctr = 0; ctr < posX.size(); ctr++){
        ...
        if(cities.remove(posX[ctr],posY[ctr]))
            cout << "OH NO!!!    " << ctr << endl;

        //file2 << cities._total_blacks << "," << cities._total_greys << "," << cities._total_whites << endl;
